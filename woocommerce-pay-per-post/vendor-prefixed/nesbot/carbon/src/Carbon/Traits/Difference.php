...
use Pramadillo\PayForPost\Carbon\CarbonInterval;
use Pramadillo\PayForPost\Carbon\CarbonPeriod;
...
trait Difference
{
     ...
     * current one).
     *
     * @param \Pramadillo\PayForPost\Carbon\CarbonInterface|\DateTimeInterface|string|null $date
