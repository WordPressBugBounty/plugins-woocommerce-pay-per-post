...
use Pramadillo\PayForPost\Carbon\Exceptions\InvalidDateException;
use Pramadillo\PayForPost\Carbon\Exceptions\InvalidFormatException;
...
trait Creator
{
    ...
    public static function rawCreateFromFormat($format, $time, $tz = null)
    {
        ...
        /** @var \Pramadillo\PayForPost\Carbon\CarbonImmutable|\Pramadillo\PayForPost\Carbon\Carbon|null $mock */
     ...
     * @param \Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface $translator optional custom translator to use for macro-formats
     *
     * @throws InvalidFormatException
     *
     * @return static|false
