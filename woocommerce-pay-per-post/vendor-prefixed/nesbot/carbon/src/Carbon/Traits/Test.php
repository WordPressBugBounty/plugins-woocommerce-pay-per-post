...
use Pramadillo\PayForPost\Carbon\CarbonTimeZone;
use Closure;
...
trait Test
{
     ...
     *
     * @return \Pramadillo\PayForPost\Carbon\CarbonImmutable|\Pramadillo\PayForPost\Carbon\Carbon|null
     */
    protected static function getMockedTestNow($tz)
    {
        ...
        /* @var \Pramadillo\PayForPost\Carbon\CarbonImmutable|\Pramadillo\PayForPost\Carbon\Carbon|null $testNow */
    ...
    {
        /** @var \Pramadillo\PayForPost\Carbon\CarbonImmutable|\Pramadillo\PayForPost\Carbon\Carbon $testInstance */
