...
use Pramadillo\PayForPost\Carbon\Exceptions\InvalidTypeException;
use Pramadillo\PayForPost\Carbon\Exceptions\NotLocaleAwareException;
use Pramadillo\PayForPost\Carbon\Language;
use Pramadillo\PayForPost\Carbon\Translator;
use Pramadillo\PayForPost\Carbon\TranslatorStrongTypeInterface;
use Closure;
use Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorBagInterface;
use Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface;
use Pramadillo\PayForPost\Symfony\Contracts\Translation\LocaleAwareInterface;
use Pramadillo\PayForPost\Symfony\Contracts\Translation\TranslatorInterface as ContractsTranslatorInterface;

// @codeCoverageIgnoreStart
if (interface_exists('Pramadillo\\PayForPost\\Symfony\\Contracts\\Translation\\TranslatorInterface') &&
    !interface_exists('Pramadillo\\PayForPost\\Symfony\\Component\\Translation\\TranslatorInterface')
) {
    class_alias(
        'Pramadillo\\PayForPost\\Symfony\\Contracts\\Translation\\TranslatorInterface',
        'Pramadillo\\PayForPost\\Symfony\\Component\\Translation\\TranslatorInterface'
    );
}
...
trait Localization
{
     ...
     * Default translator.
     *
     * @var \Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @return \Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface
     */
     ...
     *
     * @param \Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface $translator
     *
     * @return void
     */
     ...
     *
     * @param \Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface $translator the translator to use
     ...
     * @param string|null                                        $locale     current locale used if null
     * @param string|null                                        $default    default value if translation returns the key
     * @param \Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface $translator an optional translator to use
     *
     * @return string
     */
     ...
     * @param \Pramadillo\PayForPost\Symfony\Component\Translation\TranslatorInterface|null $translator
     ...
     * @param \Pramadillo\PayForPost\Symfony\Component\Translation\MessageCatalogueInterface $catalogue
     *
     * @return mixed
     */
