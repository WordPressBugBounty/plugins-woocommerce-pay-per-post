...
use Pramadillo\PayForPost\Carbon\Exceptions\BadFluentConstructorException;
use Pramadillo\PayForPost\Carbon\Exceptions\BadFluentSetterException;
use Pramadillo\PayForPost\Carbon\Exceptions\InvalidCastException;
use Pramadillo\PayForPost\Carbon\Exceptions\InvalidIntervalException;
use Pramadillo\PayForPost\Carbon\Exceptions\OutOfRangeException;
use Pramadillo\PayForPost\Carbon\Exceptions\ParseErrorException;
use Pramadillo\PayForPost\Carbon\Exceptions\UnitNotConfiguredException;
use Pramadillo\PayForPost\Carbon\Exceptions\UnknownGetterException;
use Pramadillo\PayForPost\Carbon\Exceptions\UnknownSetterException;
use Pramadillo\PayForPost\Carbon\Exceptions\UnknownUnitException;
use Pramadillo\PayForPost\Carbon\Traits\IntervalRounding;
use Pramadillo\PayForPost\Carbon\Traits\IntervalStep;
use Pramadillo\PayForPost\Carbon\Traits\MagicParameter;
use Pramadillo\PayForPost\Carbon\Traits\Mixin;
use Pramadillo\PayForPost\Carbon\Traits\Options;
use Pramadillo\PayForPost\Carbon\Traits\ToStringFormat;
use Closure;
use DateInterval;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
     ...
     *
     * @throws \Pramadillo\PayForPost\Carbon\Exceptions\ParseErrorException when the $interval cannot be parsed as an interval.
     *
     * @return static
     */
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        /** @var \Pramadillo\PayForPost\Symfony\Component\Translation\Translator $translator */
