...
use Pramadillo\PayForPost\Carbon\Exceptions\EndLessPeriodException;
...
use Pramadillo\PayForPost\Carbon\Exceptions\InvalidPeriodDateException;
use Pramadillo\PayForPost\Carbon\Exceptions\InvalidPeriodParameterException;
use Pramadillo\PayForPost\Carbon\Exceptions\NotACarbonClassException;
use Pramadillo\PayForPost\Carbon\Exceptions\NotAPeriodException;
use Pramadillo\PayForPost\Carbon\Exceptions\UnknownGetterException;
use Pramadillo\PayForPost\Carbon\Exceptions\UnknownMethodException;
use Pramadillo\PayForPost\Carbon\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
     ...
     *
     * @param \Pramadillo\PayForPost\Carbon\Carbon|\Pramadillo\PayForPost\Carbon\CarbonPeriod|\Pramadillo\PayForPost\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return bool
     */
     ...
     *
     * @param \Pramadillo\PayForPost\Carbon\CarbonPeriod|\DatePeriod|string $period
     *
     * @return bool
     */
     ...
     * @SuppressWarnings(PHPMD.UnusedFormalParameter)
     *
     * @param \Pramadillo\PayForPost\Carbon\Carbon $current
     * @param int            $key
     *
     * @return bool|string
     */
     ...
     * @param \Pramadillo\PayForPost\Carbon\Carbon|\Pramadillo\PayForPost\Carbon\CarbonPeriod|\Pramadillo\PayForPost\Carbon\CarbonInterval|\DateInterval|\DatePeriod|\DateTimeInterface|string|null $date
     *
     * @return \Pramadillo\PayForPost\Carbon\CarbonInterface
     */
