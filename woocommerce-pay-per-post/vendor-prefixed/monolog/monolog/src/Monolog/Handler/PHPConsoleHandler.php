...
namespace Pramadillo\PayForPost\Monolog\Handler;

use Exception;
use Pramadillo\PayForPost\Monolog\Formatter\LineFormatter;
use Pramadillo\PayForPost\Monolog\Logger;
use Pramadillo\PayForPost\Monolog\Utils;
 ...
 *
 *      $logger = new \Pramadillo\PayForPost\Monolog\Logger('all', array(new \Pramadillo\PayForPost\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    private $options = array(
        ...
        'classesPartialsTraceIgnore' => array('Pramadillo\\PayForPost\\Monolog\\'), // array Hide calls of classes started with...
